...
//Profile Screen
          ...
          'answer1':'The Market Rate feature provides live updates on the latest poultry market rates across various regions. It helps you stay informed about price trends in the chicken market, enabling better decision-making for buying or selling chickens.',
          'question2':'How can I receive daily notifications for the chicken mandi rates?',
          'answer2':'You can subscribe to receive daily notifications with up-to-date rates from different chicken markets (mandis). These notifications ensure you stay informed about any important price changes that may affect your buying or selling decisions.',
          'question3':'What does the AI-powered search box do?',
          'answer3':'The AI-powered search box is a tool that allows you to quickly find current market rates by entering specific queries. It fetches the latest prices across multiple locations, making it easier to access the information you need.',
          'question4':'How can I view historical price charts?',
          'answer4':'To view historical price trends, simply navigate to the "Historical Price Charts" section. This feature displays past chicken prices, helping you analyze and predict future market movements based on historical data.',
          'question5':'What are Customized Alerts, and how do I set them?',
          'answer5':'Customized Alerts let you set specific price thresholds for chicken market rates. When the market hits your desired price range, you will receive an automatic notification. To set an alert, simply specify location, and the system will notify you accordingly.',
          'question6':'How frequently are the market rates updated?',
          'answer6':'Market rates are updated in real-time to provide the latest and most accurate price information across various chicken markets.',
          'question7':'Can I access market rates for multiple regions?',
          'answer7':'Yes, you can view market rates for multiple regions using both the live updates and AI-powered search feature. You can customize your view based on the regions that are most relevant to you.',
          'question8':'Is there a subscription cost for these features?',
          'answer8':'Please check the pricing section on our platform for any details regarding subscription fees for accessing Freemium or Professional features like customized alerts and historical price data.',
          'question9':'How accurate are the market rate updates?',
          'answer9':'The market rates are pulled from reliable sources and updated frequently to ensure accuracy. However, occasional delays or discrepancies may occur due to varying factors in different regions.',
